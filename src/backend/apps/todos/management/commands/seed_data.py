...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write('  • Todo Detail: GET/PUT/PATCH/DELETE /api/todos/{id}/')
        self.stdout.write('  • Complete: POST /api/todos/{id}/complete/')
        self.stdout.write('  • Statistics: GET /api/todos/statistics/')
        self.stdout.write('  • My Todos: GET /api/todos/my_todos/')
